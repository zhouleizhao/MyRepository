...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        [_selectView insertSubview:view atIndex:0];
        //左侧取消按钮
...
- (void)p_setPickerView{
    ...
    _pickView.frame=CGRectMake(0, 40, _selectView.frame.size.width, _selectView.frame.size.height-40);
...
- (CGRect)showSelectViewFrame{
    return CGRectMake(0, CGRectGetHeight(self.frame)-190, CGRectGetWidth(self.frame), 190);
}

- (CGRect)hideSelectViewFrame{
    return CGRectMake(0, CGRectGetHeight(self.frame), CGRectGetWidth(self.frame), 190);
}
